...
class Public_Assistance_Benefits(Form):
    ...
    registeredSelectiveService = SelectField('Are you registered with a selective service? * Please select "Not Applicable" if this does not apply to you.', choices=[('1','Please select...'), ('2', 'Yes'), ('3', 'No'), ('4', 'Not Sure'), ('5', 'Not Applicable')])